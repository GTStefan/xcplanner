...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="XCLoad()" onunload="XCUnload()" onresize="XCResize()" scroll="no">
		<div id="left">
			...
			<input type="submit" onclick="XCHere();LivesharingUpdate();" value="Reset" title="Place the turnpoints on the map" /><br/>
			<hr/>
			...
			<input type="submit" onclick="XCRotateRoute(1);LivesharingUpdate();" value="&#8631;" title="Rotate clockwise"/>
			<input type="submit" onclick="XCReverseRoute();LivesharingUpdate();" value="&#8644;" title="Reverse"/>
			<input type="submit" onclick="XCRotateRoute(-1);LivesharingUpdate();" value="&#8630;" title="Rotate anti-clockwise"/>
